    ...
    return (
        <div className="min-h-screen p-2">
            <div className="max-w-7xl mx-auto">
                {/* Header Card */}
                <div className="bg-white rounded-tl-lg border border-gray-200 p-2 mb-0">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            <h2 className="text-2xl text-gray-900">Roles</h2>
                        </div>
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <button
                                ...
                                className="bg-[#2FB4FF] text-white px-4 py-2 rounded-lg flex items-center space-x-2 transition-colors"
                            >
                ...
                {/* Roles Table - Moved closer to header */}
