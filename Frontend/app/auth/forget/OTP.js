...
export default function ShopifyOTPVerification() {
            ...
            <div className="relative z-10 min-h-screen flex items-center justify-center px-4">
                <div className="w-full max-w-md">
                    ...
                    <div className="rounded-2xl  px-8 py-12">
                        ...
                        <h1 className="text-2xl font-bold  text-[#101010] text-center mb-8">
                            OTP Verification
                        </h1>
                        ...
                        <div className="flex justify-center gap-4 mb-10">
                            {otp.map((digit, index) => (
                                <input
                                    ...
                                    className="w-16 h-16 text-center text-2xl font-medium border-2 border-[#000000] rounded-lg focus:outline-none focus:border-[#2FB4FF] focus:ring-1 focus:ring-blue-100 transition-all"
                                />
                            ))}
                        </div>
                        ...
                        <button
                            ...
                            className={`w-full py-4 px-6 rounded-lg font-medium text-white text-lg transition-all ${otp.join('').length === 4 && !isSubmitting
                                ? 'bg-[#2FB4FF] hover:bg-blue-600'
                                : 'bg-[#2FB4FF] cursor-not-allowed'
                                }`}
                        >
                            {isSubmitting ? (
