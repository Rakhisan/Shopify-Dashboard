      ...
      <div className="flex flex-col lg:flex-row max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-64 bg-white shadow-sm p-6 lg:sticky lg:top-0">
          ...
          <nav className="space-y-2">
            ...
            <div
              className="flex items-center space-x-2 p-2 rounded-lg cursor-pointer transition-colors hover:bg-gray-300"
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900">Inventory Change</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    We will notify you when a related product you are importing has the status
                ...
                <div className="flex-shrink-0">
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.inventoryChange
                      ? 'bg-[#30B4FF]'
                      : 'bg-gray-200'
                      }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notifications.inventoryChange
                        ? 'translate-x-6'
                        : 'translate-x-1'
                        }`}
                    />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    When the product cost of the supplier you mapped has changed, We will
                    notify you.
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.priceChanges
                      ? 'bg-[#30B4FF]'
                      : 'bg-gray-200'
                      }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notifications.priceChanges
                        ? 'translate-x-6'
                        : 'translate-x-1'
                        }`}
                    />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900">SKU changes</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    We will notify you when the supplier's product SKU name you are mapping
                    changes or item or options added, causing the mapping to fail
                  </p>
                </div>
                <div className="flex-shrink-0">
                  <button
                    onClick={() => toggleNotification('skuChanges')}
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${notifications.skuChanges
                      ? 'bg-[#30B4FF]'
                      : 'bg-gray-200'
                      }`}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notifications.skuChanges
                        ? 'translate-x-6'
                        : 'translate-x-1'
                        }`}
                    />
